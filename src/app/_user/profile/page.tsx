...
function PasswordChangeForm() {
  ...
  const [confirmNewPasswordIsValid, setConfirmNewPasswordIsValid] =
    React.useState(true);
      ...
      <div>
        ...
        <div>
          <TextField
            ...
            helperText={
              !confirmNewPasswordIsValid ? "Passwords do not match" : ""
            }
          />
        </div>
        <div>
          <Button variant="outlined" onClick={saveNewPassword}>
            Save
          </Button>
        </div>
      </div>
