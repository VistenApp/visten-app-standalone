...
interface RuntimeProps {
    hours: number; setHours: (hours: number) => void;
    minutes: number; setMinutes: (minutes: number) => void;
}

export default function RuntimeSelect({ hours, setHours, minutes, setMinutes }: RuntimeProps) {
    ...
    return (
        <>
            <Typography component="legend" mb={1}>Maximum Runtime</Typography>
            <Box sx={{
                display: "flex",
